...
class ArchitectureTest {
    ...
    @ArchTest
    static final ArchRule APPLICATION_MUST_NOT_DEPEND_ON_MYBATIS =
            noClasses()
                    .that()
                    .resideInAPackage("..application..")
                    .should()
                    .dependOnClassesThat()
                    .resideInAnyPackage("org.mybatis..", "org.apache.ibatis..");
    ...
    @ArchTest
    static final ArchRule CONTROLLERS_STAY_IN_API_PACKAGES =
            classes()
                    .that()
    ...
    @ArchTest
    static final ArchRule MAPPERS_STAY_IN_INFRASTRUCTURE =
            classes()
                    .that()
