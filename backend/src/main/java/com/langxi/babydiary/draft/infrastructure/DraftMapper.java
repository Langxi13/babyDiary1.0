package com.langxi.babydiary.draft.infrastructure;
...
public interface DraftMapper {
    ...
    @Delete(
            "DELETE FROM diary_draft WHERE space_id=#{spaceId} AND owner_id=#{ownerId} AND draft_key=#{draftKey}")
    void delete(
            @Param("spaceId") long spaceId,
            @Param("ownerId") long ownerId,
            @Param("draftKey") String draftKey);
    ...
    final class DraftRow {
        ...
        public void setDiaryPublicId(byte[] diaryPublicId) {
            this.diaryPublicId = diaryPublicId;
        }
