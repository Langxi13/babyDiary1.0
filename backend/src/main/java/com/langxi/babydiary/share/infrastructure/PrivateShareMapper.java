...
public interface PrivateShareMapper {
    ...
    @Update(
            "UPDATE private_share SET view_count=view_count+1 WHERE share_id=#{shareId} AND revoked_at IS NULL "
    ...
    @Update(
            "UPDATE private_share SET revoked_at=UTC_TIMESTAMP(6) WHERE public_id=#{publicId} "
    ...
    class DiaryRow {
        ...
        public void setDiaryId(long v) {
            diaryId = v;
        }

        public void setAuthorId(long v) {
            authorId = v;
        }
        ...
        public void setMoodKey(String v) {
            moodKey = v;
        }
    ...
    class ShareRow {
        ...
        public void setMaxViews(Integer v) {
            maxViews = v;
        }
