...
public class SlowRequestLoggingInterceptor implements HandlerInterceptor {
    ...
    private static final String START_TIME = SlowRequestLoggingInterceptor.class.getName() + ".startTime";

    private final long thresholdMillis;

    public SlowRequestLoggingInterceptor(@Value("${app.http.slow-request-threshold-ms:1000}") long thresholdMillis) {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        if (elapsedMillis >= thresholdMillis) {
            log.warn("Slow request method={} path={} status={} elapsedMs={}", request.getMethod(),
