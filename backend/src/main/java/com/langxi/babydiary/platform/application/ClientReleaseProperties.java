...
public class ClientReleaseProperties {
    ...
    public static final class Android {
        ...
        public void setDistribution(String distribution) { this.distribution = normalized(distribution); }
        ...
        public void setLatestVersionName(String latestVersionName) { this.latestVersionName = normalized(latestVersionName); }
        public int getMinimumVersionCode() { return minimumVersionCode; }
        public void setMinimumVersionCode(int minimumVersionCode) { this.minimumVersionCode = Math.max(1, minimumVersionCode); }
        public String getDownloadUrl() { return downloadUrl; }
        public void setDownloadUrl(String downloadUrl) { this.downloadUrl = normalized(downloadUrl); }
        public String getSha256() { return sha256; }
        public void setSha256(String sha256) { this.sha256 = normalized(sha256); }
        public String getReleaseNotes() { return releaseNotes; }
        public void setReleaseNotes(String releaseNotes) { this.releaseNotes = normalized(releaseNotes); }
