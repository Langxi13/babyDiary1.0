package com.langxi.babydiary.details;
...
public class CustomUserDetails implements UserDetails {
    ...
    public CustomUserDetails(Integer userId, String username, String password, Collection<? extends GrantedAuthority> authorities) {
        this(userId, username, password, 0, authorities);
    }

    public CustomUserDetails(Integer userId, String username, String password, Integer tokenVersion, Collection<? extends GrantedAuthority> authorities) {
        this.userId = userId;
