...
public class AccountRecoveryController {
    ...
    public void confirm(
            @Valid @RequestBody TokenRequest request, HttpServletRequest servletRequest) {
    ...
    public void requestReset(
        ...
        rateLimiter.require(
                "reset-request",
                rateLimiter.client(servletRequest) + ":" + request.email(),
                5,
                3600);
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void recover(
            @Valid @RequestBody RecoverRequest request, HttpServletRequest servletRequest) {
        rateLimiter.require(
                "password-recover",
                rateLimiter.client(servletRequest) + ":" + request.username(),
                10,
                3600);
