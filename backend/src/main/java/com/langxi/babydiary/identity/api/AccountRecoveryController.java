...
public class AccountRecoveryController {
    ...
    public EmailResponse email(@AuthenticationPrincipal AccountPrincipal principal, @Valid @RequestBody EmailRequest request) {
    ...
    public List<String> codes(@AuthenticationPrincipal AccountPrincipal principal, @Valid @RequestBody PasswordRequest request) {
