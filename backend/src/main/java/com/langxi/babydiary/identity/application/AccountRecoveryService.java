...
import com.langxi.babydiary.identity.infrastructure.AccountRecoveryMapper;
...
public class AccountRecoveryService {
    ...
    public void requestPasswordReset(String email) {
        String value;
        try { value = normalizeEmail(email); } catch (ApiException ignored) { return; }
    ...
    private ApiException tokenInvalid() { return new ApiException(HttpStatus.UNAUTHORIZED, "RECOVERY_TOKEN_INVALID", "验证链接无效或已过期"); }
