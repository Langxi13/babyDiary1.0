...
public class AuthController {
    ...
    @PostMapping("/step-up")
    public StepUpResponse stepUp(@AuthenticationPrincipal AccountPrincipal principal, @Valid @RequestBody PasswordRequest request,
                                 HttpServletRequest servletRequest) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void revokeSession(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID sessionId) {
