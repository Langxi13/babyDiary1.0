...
public interface DiaryMapper {
    ...
    @Insert(
            "INSERT INTO diary_tag(space_id,diary_id,tag_id) VALUES(#{spaceId},#{diaryId},#{tagId})")
    void insertTag(
            @Param("spaceId") long spaceId,
            @Param("diaryId") long diaryId,
    ...
    @Insert(
            "INSERT INTO diary_media(space_id,diary_id,asset_id,position) VALUES(#{spaceId},#{diaryId},#{assetId},#{position})")
    void insertMedia(
            @Param("spaceId") long spaceId,
            @Param("diaryId") long diaryId,
