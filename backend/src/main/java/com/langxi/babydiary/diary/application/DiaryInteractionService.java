...
import com.langxi.babydiary.diary.infrastructure.DiaryInteractionMapper;
...
public class DiaryInteractionService {
    ...
    private long requireDiary(UUID spaceId, UUID diaryId, long accountId,boolean elevated) {
        ...
        if(row.isLocked()&&!elevated)throw new ApiException(HttpStatus.LOCKED,"STEP_UP_REQUIRED","请先完成二次验证");
