...
public class DiaryInteractionController {
    ...
    @GetMapping("/comments")
    public List<DiaryInteractionService.Comment> comments(@AuthenticationPrincipal AccountPrincipal principal,
    ...
    public DiaryInteractionService.Comment addComment(@AuthenticationPrincipal AccountPrincipal principal,
                                                       @PathVariable UUID spaceId, @PathVariable UUID diaryId,
    ...
    public void updateComment(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
    ...
    public void deleteComment(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
                              @PathVariable UUID diaryId, @PathVariable UUID commentId,
                              @RequestHeader(value="X-Step-Up-Token",required=false)String token) {
    ...
    public List<DiaryInteractionService.Reaction> reactions(@AuthenticationPrincipal AccountPrincipal principal,
                                                             @PathVariable UUID spaceId, @PathVariable UUID diaryId,
                                                             @RequestHeader(value="X-Step-Up-Token",required=false)String token) {
    ...
    public void setReaction(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
