...
public class MediaController {
    ...
    public ResponseEntity<MediaView> upload(@AuthenticationPrincipal AccountPrincipal principal,
    ...
    @GetMapping
    public MediaPageResponse list(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
    ...
    @GetMapping("/{assetId}")
    public MediaView detail(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
    ...
    public ResponseEntity<StreamingResponseBody> content(@AuthenticationPrincipal AccountPrincipal principal,
    ...
    @PutMapping("/{assetId}")
    public MediaView update(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
