...
public class AiConfigService {
    ...
    public AiConfigService(AiConfigRepository configs, AiClient client,
    ...
    public String test(AccountPrincipal principal) {
        requireAdmin(principal);
        return client.generate(runtime(), java.util.List.of(new AiClient.Message("user", "请只回复 OK，用于测试连接。")));
    }
