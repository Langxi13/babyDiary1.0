...
public class AiAlbumProposalController {
    ...
    public ProposalResponse generate(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
    ...
    public ProposalResponse detail(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
                                   @PathVariable UUID proposalId) {
        return response(principal.accountId(), proposals.detail(spaceId, principal.accountId(), proposalId));
    }

    @PutMapping("/{proposalId}")
    public ProposalResponse update(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
    ...
    public ProposalResponse confirm(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
                                    @PathVariable UUID proposalId) {
    ...
    public void dismiss(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
                        @PathVariable UUID proposalId) {
