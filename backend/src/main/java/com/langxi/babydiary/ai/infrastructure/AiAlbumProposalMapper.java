...
public interface AiAlbumProposalMapper {
    ...
    @Select(
            ...
            """)
    ProposalRow findProposal(
            @Param("spaceId") long spaceId,
            @Param("accountId") long accountId,
            @Param("publicId") byte[] publicId);

    @Update(
            "UPDATE ai_album_proposal SET status=#{status},updated_at=UTC_TIMESTAMP(6) "
    ...
    @Insert(
            "INSERT INTO ai_album_candidate_diary(space_id,candidate_id,diary_id,position) VALUES(#{spaceId},#{candidateId},#{diaryId},#{position})")
    void insertCandidateDiary(
            @Param("spaceId") long spaceId,
    ...
    @Insert(
            "INSERT INTO ai_album_candidate_media(space_id,candidate_id,asset_id,position) VALUES(#{spaceId},#{candidateId},#{assetId},#{position})")
    void insertCandidateMedia(
            @Param("spaceId") long spaceId,
            @Param("candidateId") long candidateId,
    ...
    @Select(
            ...
            """)
    List<DiaryMediaRow> findDiaryMedia(
            @Param("spaceId") long spaceId,
            @Param("accountId") long accountId,
    ...
    @Select(
            ...
            """)
    List<IdRow> resolveMedia(
            @Param("spaceId") long spaceId,
            @Param("accountId") long accountId,
            @Param("diaryIds") List<byte[]> diaryIds,
            @Param("ids") List<byte[]> ids);
    ...
    final class ProposalInsert {
        ...
        public void setProposalId(Long v) {
            proposalId = v;
        }
    ...
    final class CandidateInsert {
        ...
        private final Long targetAlbumId;
    ...
    final class ProposalRow {
        ...
        public void setSpacePublicId(byte[] v) {
            spacePublicId = v;
        }
    ...
    final class CandidateRow {
        ...
        private byte[] targetAlbumPublicId;
        ...
        public byte[] getTargetAlbumPublicId() {
            return targetAlbumPublicId;
        }
        ...
        public void setDiscarded(boolean v) {
            discarded = v;
        }
        ...
        public void setTargetAlbumPublicId(byte[] v) {
            targetAlbumPublicId = v;
        }

        public void setTargetAlbumName(String v) {
            targetAlbumName = v;
        }
    }
