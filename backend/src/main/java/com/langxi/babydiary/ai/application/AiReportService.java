...
public class AiReportService {
    ...
    public AiReportService(SpaceAccess spaces, AiConfigService configs, AiClient client, AiReportRepository reports) {
        this.spaces = spaces;
    ...
    public AiReportRepository.Report generate(UUID spaceId, long accountId, String type, String period) {
        ...
        if (diaries.isEmpty()) throw ApiException.badRequest("AI_REPORT_NO_DIARIES", "该周期没有可用于报告的日记");
    ...
    private Period resolve(String type, String period) {
        ...
        throw ApiException.badRequest("AI_REPORT_PERIOD_INVALID", "报告周期格式无效，请使用 yyyy-MM 或 yyyy-Www");
    }
