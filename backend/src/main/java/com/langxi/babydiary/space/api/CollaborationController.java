...
public class CollaborationController {
    ...
    public List<CollaborationRepository.Member> members(@AuthenticationPrincipal AccountPrincipal principal,
    ...
    public CollaborationService.InvitationCreated invite(@AuthenticationPrincipal AccountPrincipal principal,
                                                          @PathVariable UUID spaceId,
    ...
    public void accept(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable String token) {
        collaboration.accept(token, principal.accountId());
    }

    @PutMapping("/spaces/{spaceId}/members/{accountId}/role")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void updateRole(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void removeMember(@AuthenticationPrincipal AccountPrincipal principal, @PathVariable UUID spaceId,
