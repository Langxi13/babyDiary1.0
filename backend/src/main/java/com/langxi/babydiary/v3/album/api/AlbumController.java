...
public class AlbumController {
  ...
  public AlbumCatalogResponse catalog(
    ...
    return AlbumCatalogResponse.from(
        albums.catalog(spaceId, principal.accountId()), media, principal.accountId(), elevated);
  }
  ...
  public AlbumResponse createAlbum(
    ...
    return AlbumResponse.from(
        album, media, MediaAccessContext.album(principal.accountId(), album.id(), elevated));
  }
  ...
  public void favorite(
      ...
      @PathVariable UUID assetId,
      @RequestHeader(value = "X-Step-Up-Token", required = false) String token) {
    albums.favorite(spaceId, assetId, principal.accountId(), true, stepUp.valid(principal, token));
  }
  ...
  public void unfavorite(
      ...
      @PathVariable UUID assetId,
      @RequestHeader(value = "X-Step-Up-Token", required = false) String token) {
    albums.favorite(spaceId, assetId, principal.accountId(), false, stepUp.valid(principal, token));
  }
  ...
  public record AlbumCatalogResponse(List<GroupResponse> groups) {
    static AlbumCatalogResponse from(
        AlbumCatalog catalog, MediaRepresentationService media, long accountId, boolean elevated) {
  ...
  public record AlbumResponse(
    ...
    static AlbumResponse from(
        AlbumCatalog.Album album, MediaRepresentationService media, MediaAccessContext context) {
