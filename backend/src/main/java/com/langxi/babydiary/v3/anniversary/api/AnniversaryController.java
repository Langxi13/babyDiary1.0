...
public class AnniversaryController {
  ...
  public AnniversaryController(
      AnniversaryService anniversaries, MediaRepresentationService media, StepUpService stepUp) {
  ...
  private Response response(AnniversaryService.Item item, long accountId, boolean elevated) {
    ...
    MediaView cover =
        item.coverMedia() == null
            ? null
            : media.view(
                item.coverMedia(), MediaAccessContext.anniversary(accountId, value.id(), elevated));
    return new Response(
        value.id(),
        value.spaceId(),
        value.title(),
