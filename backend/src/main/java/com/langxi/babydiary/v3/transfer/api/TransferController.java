package com.langxi.babydiary.v3.transfer.api;

import com.langxi.babydiary.v3.identity.application.V3Principal;
import com.langxi.babydiary.v3.transfer.application.DiaryBookService;
import com.langxi.babydiary.v3.transfer.application.PortableArchiveService;
import com.langxi.babydiary.v3.transfer.application.TemporaryDownload;
...
public class TransferController {
    ...
    public ResponseEntity<TemporaryDownload> exportArchive(@AuthenticationPrincipal V3Principal principal,
    ...
    public PortableArchiveService.ImportResult importArchive(@AuthenticationPrincipal V3Principal principal,
                                                               @PathVariable UUID spaceId,
    ...
    @GetMapping("/books")
    public ResponseEntity<TemporaryDownload> exportBook(@AuthenticationPrincipal V3Principal principal,
                                                         @PathVariable UUID spaceId,
